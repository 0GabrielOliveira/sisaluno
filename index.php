    ...
    <div class="princ">
        ...
        <div class="menu">
            ...
            <div class="caddisciplinas">
                <h3>Disciplinas</h3>
                <h4>Clique aqui para cadastrar novas disciplinas</h4>
                <button class="button"><a href="disciplinas\caddisciplina.php">Cadastrar disciplina</a></button> <br>
                <h4>Clique aqui para visualizar a lista de disciplinas cadastradas</h4>
                <button class="button"><a href="disciplinas\listadisciplinas.php">Exibir lista de disciplinas</a></button>
            </div>
        </div>
    </div>
